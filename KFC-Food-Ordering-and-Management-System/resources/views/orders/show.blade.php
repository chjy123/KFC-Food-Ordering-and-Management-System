...
<div class="container mx-auto py-12">
    ...
    <div class="mt-6 flex justify-end">
        <a href="{{ route('menu.index') }}" class="px-6 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 mr-3">Continue Shopping</a>
        <button class="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">Proceed to Payment</button>
    </div>
</div>
